...
clear_window()
planet=draw_ball(coords)

while True:
    planet.move(velocity.x, velocity.y)
    acceleration = update_acceleration(planet.getCenter(), gr.Point(400, 400))
    velocity = update_velocity(velocity, acceleration)
    check_coords(planet.getCenter(), velocity)
    gr.time.sleep(0.02)
